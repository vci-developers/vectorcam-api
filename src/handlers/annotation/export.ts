...
export async function exportAnnotationsCSV(
  ...
  try {
    ...
    const csvHeader = [
      ...
      'ThumbnailOriginalSpecies',
      'ThumbnailOriginalSex',
      'ThumbnailOriginalAbdomenStatus',
      'ThumbnailCapturedAt',
    ...
    for (const annotation of annotations) {
      ...
      const row = [
        ...
        escapeCSVField(annotation.artifacts),
        ...
        escapeCSVField(thumbnailImage?.metadata ? JSON.stringify(thumbnailImage.metadata) : null),
        escapeCSVField(thumbnailImage?.species),
        escapeCSVField(thumbnailImage?.sex),
        escapeCSVField(thumbnailImage?.abdomenStatus),
        escapeCSVField(thumbnailImage?.originalSpecies),
        escapeCSVField(thumbnailImage?.originalSex),
        escapeCSVField(thumbnailImage?.originalAbdomenStatus),
